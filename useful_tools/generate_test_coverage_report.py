...
def generate_test_coverage_report(
    ...
    def print_coverage_message():
        if test_coverage < minimum_test_coverage_percentage:
            print(f'\n{severity_level}: Current test coverage of {test_coverage}% is below required threshold of {minimum_test_coverage_percentage}%.')
        else:
            print(f'Current test coverage of {test_coverage}% meets the required threshold of {minimum_test_coverage_percentage}%.')

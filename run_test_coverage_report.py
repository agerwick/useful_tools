...
generate_test_coverage_report(
    minimum_test_coverage_percentage = 90, # commit will fail if test coverage is below this threshold
    ...
    code_locations = ['useful_tools'], # where application code is located
    exclude_code_locations = [], # if any code locations should be excluded, for example if tests are located a subdirectory of the code location
